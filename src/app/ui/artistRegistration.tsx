...
import { UserModel } from "../lib/mongoDB/models/userModel";

export default function ArtistRegistration () {
  const [form, setForm] = useState({firstName: "", lastName: "", dateOfBirth: "", stageName: "", phoneNumber: "", location: ""});
  ...
  const handleGenericChange = (event: React.ChangeEvent<HTMLInputElement>, input: string) => {
    const value = event.target.value;
