...
export default function EditProfile () {
    ...
    <div className="flex flex-row">
        <div className="flex flex-col w-[28%] p-3 justify-start">
            <div className="shadow-[0px_4px_5px_#191922] mx-[30px] my-0 py-[18px] px-2.5 rounded-[20px] text-center" style= {{background: "linear-gradient(355deg, rgba(32,33,54,1) 0%, rgba(52,41,98,1) 100%)"}} >
        ...
        <div className="flex flex-col w-[45%] p-3 justify-center overflow-y-scroll">
            <div className="shadow-[0px_4px_5px_#191922] my-0 py-[18px] px-2.5 rounded-[20px] text-center bg-[#2f2753]">
                ...
                <div className="m-3 tracking-[1px] text-sm text-[black]">
                    <textarea className="text-center rounded-[20px] mt-1 p-3 w-[80%] h-[120px]" value={artistBio} onChange={(event) => handleBioInput(event)}/>
                </div>
            </div>
