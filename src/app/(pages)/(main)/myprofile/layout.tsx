...
export default function Layout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gridTemplateRows: 'auto 1fr' }}>
            <div style={{ gridColumn: '1 / span 3', gridRow: '2 / span 10' }} className="h-[630px] w-[510px] relative">
                ...
                <Image src={StartChat} alt="Chat button" className="w-[28px] h-[28px] absolute top-[40px] left-[78%] hover:scale-[1.2]  transition-all duration-200"/>
                <Image src={Connect} alt="Connect button" className="w-[28px] h-[28px] absolute top-[120px] left-[90%] hover:scale-[1.2] transition-all duration-200"/>
                <Image src={Spotify} alt="Spotify button" className="w-[28px] h-[28px] absolute top-[220px] left-[96%] hover:scale-[1.2] transition-all duration-200"/>
                <Image src={Instagram} alt="Instagram button" className="w-[28px] h-[28px] absolute top-[330px] left-[98%] hover:scale-[1.2] transition-all duration-200"/>
                <Image src={Youtube} alt="YouTube button" className="w-[28px] h-[28px] absolute top-[440px] left-[95%] hover:scale-[1.2] transition-all duration-200"/>
                <Image src={Tiktok} alt="Tiktok button" className="w-[30px] h-[30px] absolute top-[545px] left-[85%] hover:scale-[1.2] transition-all duration-200"/>
            </div>
            ...
            {profileLinks.map((link) => (
                <Link href={link.href}>
                    <div className={clsx(
                        "w-[100%] my-[60px] p-4 rounded-[2px] text-center tracking-[3px] text-[white] text-xs border border-solid border-[white] uppercase transition-all duration-300",
