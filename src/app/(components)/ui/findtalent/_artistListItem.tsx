...
const _ArtistListItem: React.FC<ArtistItemProps> = ({
  name,
  profilePhoto,
  tags,
  fanBase,
      ...
      <div className="shadow-[0px_4px_5px_#191922] h-[130px] flex flex-row rounded-[20px] bg-[#252531] mb-[20px] p-3">
        ...
        <div className="flex flex-col p-2 w-[300px]">
          ...
          <div className="flex flex-wrap p-2 justify-center">
            {tags.map((tag) => (
              <span className="inline px-2 py-1 mx-[10px] mt-2 text-[10px] bg-[black] text-[#ccff69] rounded-[3px] tracking-[1px] uppercase">
                {tag}
              </span>
            ))}
          </div>
        ...
        <div
          className="flex flex-row w-[250px] text-center justify-around py-2 px-5 items-center"
            ...
            return (
              <div key={index} className="flex flex-col items-center">
                <Image
                  ...
                  height={29}
                  alt={social.alt}
                  className="object-contain shadow-[0px_4px_5px_#191922]"
                />
        ...
        <div
          className="flex flex-col w-[160px] items-center py-3 px-6 justify-center"
          style={{ borderLeft: "1px solid black" }}
        >
          <span className="block text-[15px] tracking-[1.5px] uppercase mt-[1px] mb-[3px] text-center">
            {numberOfEvents}
          </span>
          <span className="block text-[11px] tracking-[1.5px] uppercase mt-[1px] mb-[8px] text-center">
            Events
