...
const NerdCat = "/mockUsers/nerdy-cat.jpg";
const WhiteCat = "/mockUsers/white-cat.webp";

const messages = [
  {
    name: "Bob Meowington",
    message: "Can you perform this Friday night?",
    status: "unread",
    photo: NerdCat,
    alt: "Nerdy cat mock user",
  },
  {
    name: "Fluffer the Booker",
    message: "Thanks for such a great show!",
    status: "read",
    photo: WhiteCat,
    alt: "White cat mock user",
  },
  {
...
export default function Messages() {
  return (
    <div className="w-[380px] shadow-[0px_0px_0px_#272525] flex mr-[30px] mt-5 mb-0 p-5 rounded-[20px] bg-[#252531] overflow-x-auto overflow-y-auto">
      <div className="w-[98%]">
