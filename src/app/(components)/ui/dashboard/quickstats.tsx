...
export default function QuickStats() {
  ...
  return (
    <div className="w-[630px] flex flex-row justify-center shadow-[0px_0px_0px_#272525] mx-[30px] my-0 pt-2.5 pb-[35px] px-2.5 rounded-[20px] bg-[#252531] overflow-x-auto">
      {userStats.map((stat) => {
        let statId;
        let number;
        let type;
