...
const userStats = [
  { requests: 3 }, { bookings: 2 }, {views: 15}
]
...
export default function QuickStats() {
  return (
    ...
    {userStats.map((stat) => {
      ...
      return (
        <div className="w-[130px] h-[130px] flex flex-col justify-center text-center shadow-[0_4px_8px_0_rgba(0,0,0,0.2),0_6px_20px_0_rgba(0,0,0,0.19)] mt-[35px] mb-[15px] mx-[25px] m-5 rounded-[30%]" id={`${statId}`}>
          <div className="flex items-center justify-center text-[28px]">
          <Image src={src} height={40} width={40} alt={`${type} icon`} className="mr-0.5"/>{number}
          </div>
