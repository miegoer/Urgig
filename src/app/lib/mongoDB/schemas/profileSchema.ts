...
import { FanBaseSchema } from "./fanBaseSchema";
...
export const ProfileSchema: Schema = new Schema({
  ...
  socialLinks: { type: SocialLinksSchema, ref: "SocialLinks", required: false }, // fixed - registration failed as it was required
  fanBase: { type: FanBaseSchema, ref: "FanBase", required: false }, // fixed - registration failed as it was required
