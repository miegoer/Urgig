    ...
    <div className="relative flex items-center justify-center h-full w-full">
      ...
      <div className="absolute text-center px-4">
        ...
        <p className="mt-4 text-xl text-gray-200">
          Connecting Artists and Promoters seamlessly.
        </p>
      </div>
    </div>
  );
...
export function AboutUs() {
  return (
    <section id="about-us" className="bg-gradient-to-b from-gray-800 to-gray-700 text-gray-100 py-12">
...
export function OurMission() {
  return (
    <section id="our-mission" className="bg-gradient-to-b from-gray-700 to-gray-800 text-gray-100 py-12">
      <div className="max-w-6xl mx-auto px-4 text-center">
        <h2 className="text-3xl font-semibold mb-6">Our Mission</h2>
        <p className="text-lg">
          Our mission is to empower artists by giving them more control over their bookings and 
          to help promoters find the perfect talent for their events. Join us and make your next gig unforgettable!
        </p>
      </div>
    </section>
  );
